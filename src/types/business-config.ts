/**
 * Contrato unificado para la configuración global del negocio.
 *
 * Bloque de tipos raíz: `BusinessGlobalConfig`.
 * Cada campo agrupa una responsabilidad específica, permitiendo configurar
 * cualquier tipo de negocio local sin modificar la capa de componentes.
 *
 * Sin Zod: la validación en tiempo de ejecución se realiza con
